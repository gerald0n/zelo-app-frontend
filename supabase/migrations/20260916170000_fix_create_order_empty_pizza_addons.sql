-- HOTFIX: private.create_order rejeitava QUALQUER pedido (não só pizza) desde
-- 20260915170000_pizza_builder.sql. O checkout sempre manda `pizza_addons`
-- como array (vazio `[]` quando o item não é pizza), e a validação testava
-- só "não é null e é array", sem checar o tamanho — então todo item
-- 'standard' caía no `raise exception 'Adicionais de pizza só valem para
-- pizza'`. Fix: só valida/erra quando o array tem pelo menos 1 elemento.
