 ...
 *
 * Fonte: `public/brand/zelo-selo-full.jpg` (wordmark preto sobre branco).
 * Rode de novo se a logo mudar: `node scripts/prepare-receipt-logo.mjs`.
 */
...
// Largura do ponto na TM-T20X é 512; 384 deixa margem e centraliza bem.
const WIDTH = 288;
...
//    a margem branca deste JPG.
const full = await sharp(SRC).grayscale().raw().toBuffer({ resolveWithObject: true });
