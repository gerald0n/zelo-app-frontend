...
| `coupons`                                                  | `20260908140000_coupons` (+ `20260912120000_coupon_full_order_discount`) | cupom: `code` uppercase único, `discount_type` (percent/fixed/free_shipping/full_order), `max_uses`, `uses_count`, período |
